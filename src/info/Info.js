  ...
  const slides = {
    ...
    1: (
      ...
      >
        ...
        <div className="text-white pb-4">
          <h5 className="text-primary3 text-lg font-semibold">هدر</h5>
          <p className="py-2 text-sm text-gray-400 font-light">
            در هدر سامانه لوگو، باکس سرچ، دکمه ارتباط با ما و راهنمای سدره
            مشاهده می شود با کلیلک روی لوگو به سایت سدره خواهید رفت با استفاده
            از باکس سرچ می توانید محدوده مورد نظر خود را روی نقشه پیدا کنید با
            استفاده از دکمه ارتباط با ما می توانید با سدره ارتباط برقرار کنید و
            پیام خود را ارسال کنید دکمه راهنمای سدره هم همین آموزشی است که در
      ...
      >
        ...
        <div className="text-white pb-4">
          ...
          <p className="py-2 text-sm text-gray-400 font-light">
            ...
            ،کنید. به ترتیب از بالا کارکرد هر ابزار را توضیح می دهیم: حالت تمام
            صفحه، بزرگ نمایی، کوچک نمایی، جهت شمال و جنوب رسم مستطیل، مارکر، حذف
            پلیگان یا مارکر.{" "}
          </p>
        </div>
    ...
    4: (
      ...
      >
        ...
        <div className="text-white pb-4">
          ...
          <p className="py-2 text-sm text-gray-400 font-light">
            در این قسمت میتوانید محدوده های ذخیره شده خود را مشاهده کنید.
          </p>
        </div>
